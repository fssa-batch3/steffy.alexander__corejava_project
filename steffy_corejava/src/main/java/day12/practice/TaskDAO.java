...
//	            Class.forName("com.mysql.cj.jdbc.Driver");
	...
	public static void createTask(Tasks task) throws DAOException {
	...
	public void updateTask(Tasks task) throws DAOException {
		// Write code here to get connection
		Connection connection = null;
		try {
	...
	public static List<Tasks> getAllTasks() throws DAOException {
		// Write code here to get connection
		Connection connection = null;
		try {
